from src.tools.productos import consultar_productos,obtener_producto,actualizar_producto,eliminar_producto,buscar_productos
...
tools = [consultar_productos,obtener_producto,actualizar_producto,eliminar_producto,buscar_productos]
